...
from third_party.smoothing_adversarial.architectures import ARCHITECTURES, get_architecture
...
from third_party.smoothing_adversarial.train_utils import AverageMeter, accuracy, init_logfile, log
